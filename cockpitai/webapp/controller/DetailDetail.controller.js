sap.ui.define([
    ...
    return Controller.extend("cockpitai.controller.DetailDetail", {
        formatter: formatter,
        onInit: function () {
        ...
        openHistory: async function () {
            ...
            if (!this.histFrg) {
                this.histFrg = await this.loadFragment({
                    name: "cockpitai.fragment.HistoryFrg"
        ...
        openCommitMsg: async function () {
            ...
            if (!this.gitFrg) {
                this.gitFrg = await this.loadFragment({
                    name: "cockpitai.fragment.addGitDetails"
                }).then(function (oDialog) {
                    this.gitFrg = oDialog;
