sap.ui.define([
  ...
  function ensureJsPDFLoaded() {
    ...
    // Build candidate URLs (correct app namespace is "cockpitai", with trailing q).
    var candidates = [];
    try {
      var u1 = sap.ui.require.toUrl("cockpitai/lib/jspdf.umd.min.js");
      if (u1) { candidates.push(u1); }
    } catch (e) { /* ignore */ }
    try {
      var base = sap.ui.require.toUrl("cockpitai");
