            ...
            createJSONModel: function (oCtrl, modelOf) {
                ...
                if (modelOf === "currFrgModel") {
                    ...
                    var tcgModel = new sap.ui.model.json.JSONModel({
                        wordFilePath: sap.ui.require.toUrl("cockpitai/templates/TCG_Template_File.docx"),
                        excelFilePath: sap.ui.require.toUrl("cockpitai/templates/TCG_Template_File.xlsx"),
                        linkVis: false,
                        wordorExcel: "",
                        selVal: "",
                        allResponses: []
                ...
                _oDeploymentIdPromise = fetch(basePath + "/lm/deployments", {
                    ...
                    .then(function (data) {
                        var deployment = (data.resources || []).find(function (item) {
                            return item.configurationName === "defaultOrchestrationConfig" &&
                                item.status === "RUNNING";
                        });
